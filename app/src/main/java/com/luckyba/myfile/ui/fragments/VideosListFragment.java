...
import com.luckyba.myfile.ui.adapter.VideosListAdapter;
...
public class VideosListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(MyApplication.getInstance().getApplicationContext(), recyclerView, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Uri photoURI = FileProvider.getUriForFile(getContext(), MyApplication.getInstance().getPackageName() + ".provider", new File(mediaFileListModel.getFilePath()));
    ...
    private void getVideosList() {
        @SuppressWarnings("deprecation") final Cursor mCursor = MyApplication.getInstance().getApplicationContext().getContentResolver().query(
