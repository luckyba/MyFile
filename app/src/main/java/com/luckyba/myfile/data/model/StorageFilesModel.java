...
public class StorageFilesModel {
    ...
    public StorageFilesModel() {}

    public StorageFilesModel(String fileName, String filePath, boolean isDir, boolean isSelected, boolean isCheckboxVisible, int type) {
    ...
    public StorageFilesModel(StorageFilesModel.Builder builder) {
    ...
    public static class Builder {
        ...
        public StorageFilesModel build() {
            return new StorageFilesModel(this);
        }
